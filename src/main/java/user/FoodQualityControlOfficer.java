...
public class FoodQualityControlOfficer extends Employee {
    public FoodQualityControlOfficer(int userId, String password, String fullName, String role, String dateOfBirth, String gender, String email, String phone, String address, String status, int employeeId, LocalDate joinDate, String department, String designation, String shift, float salary) {
