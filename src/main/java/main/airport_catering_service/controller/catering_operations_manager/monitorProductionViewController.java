...
public class monitorProductionViewController
{
    @javafx.fxml.FXML
    ...
    @javafx.fxml.FXML
    private Label fxidPreparationstatusLabel;
    @javafx.fxml.FXML
    private Label fxidPackagingStatusLabel;
    @javafx.fxml.FXML
    private Label fxidShowAirlineNamelabel112;
    @javafx.fxml.FXML
    private Label fxidCookingStatusLabel;
    @javafx.fxml.FXML
