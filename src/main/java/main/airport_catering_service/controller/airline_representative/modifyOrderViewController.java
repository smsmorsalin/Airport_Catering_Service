...
public class modifyOrderViewController
{
    @javafx.fxml.FXML
    private TextField fxidSerialNumberFromTable;
    @javafx.fxml.FXML
    private TextField fxidQuantity;
    @javafx.fxml.FXML
    private Button editMealButton;
    @javafx.fxml.FXML
    private TableColumn TableColOrderedMealSerialNumber;
    @javafx.fxml.FXML
    private AnchorPane fxidHiddenMainAnchorPane;
    @javafx.fxml.FXML
    private AnchorPane fxidHiddenSubAnchorpanel;
    @javafx.fxml.FXML
    private TableColumn TableColOrderedMealMealName;
    @javafx.fxml.FXML
    private ComboBox selectedMealComboBox;
    @javafx.fxml.FXML
    private TableView orderedMealTableviewFxid;
    @javafx.fxml.FXML
    private TableColumn TableColOrderedMealQuantity;
    @javafx.fxml.FXML
